...
func validateCreate(parent eventdomain.Event, input CreateInput) (Offering, error) {
...
func allowsCommercialParent(status eventdomain.Status) bool {
    switch status {
    case eventdomain.StatusDraft, eventdomain.StatusPublished, eventdomain.StatusActive, eventdomain.StatusSuspended:
        return true
    default:
        return false
    }
